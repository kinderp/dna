...
| --- | --- | --- | --- |
| [2026-07-18 — porta map matching](2026-07-18-map-matcher-port.md) | Sessione route-bound, esiti, fake, testkit e pipeline progress. | [#19](https://github.com/kinderp/tdna/issues/19) / [#20](https://github.com/kinderp/tdna/pull/20) | Pre-final-review; ledger finale nella PR. |
