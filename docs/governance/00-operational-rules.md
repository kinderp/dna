...
Questo documento è la costituzione pratica del monorepo. Le procedure dettagliate di review sono in [01-review-and-merge.md](01-review-and-merge.md). I comandi Git correnti sono spiegati nella [guida del monorepo](02-git-monorepo.md).
